...
def get_args():
    ...
    parser.add_argument(
        "--img_dir", type=str, default=r"R:\disk1\01.Datasets\06.jz\一丰数据\907-燃油管-res\二线\0", help="图片路径"
    )
    parser.add_argument(
        "--yolo_dir",
        type=str,
        default=r"R:\disk1\01.Datasets\06.jz\一丰数据\907-燃油管-res\二线\0-yolo-txt\labels",
        help="txt文件路径",
    )
